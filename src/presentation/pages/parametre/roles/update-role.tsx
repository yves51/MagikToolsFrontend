...
const UpdateRole = () => {
  ...
  const initialiserFormulaire = (role: Role) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await roleService.update(role.id, modifierRole); // ✅ Passer l'ID et les données
