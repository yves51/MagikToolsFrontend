...
const AjouterEtatMateriel = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const nouveauData: EtatMateriel = {
        id: 0,
        name: libelle,
      ...
      await etatMaterileService.create(nouveauData);
      toast.success("Etat de materiel créé avec succès !");
      setTimeout(() => {
  ...
  return (
    <>
      <div className="bg-white p-4 rounded shadow-sm">
        <h2 className="mb-4">Création d'Etat de materiel</h2>
...
export default AjouterEtatMateriel;
