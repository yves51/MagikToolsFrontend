...
const AjouterMateriel = () => {
  ...
  const [selectedSousCategorie, setSelectedSousCategorie] = useState<number | "">("");
  ...
  const [selectedEntreprise, setSelectedEntreprise] = useState<number | "">("");
  ...
  const loadData = async () => {
    try {
      ...
      if (etatMaterielResponse.success) setEtatMateriels(etatMaterielResponse.results);
      ...
      if (entrepriseResponse.success) setEntreprises(entrepriseResponse.results);
  ...
  const loadSousCategories = async (categorieId: number) => {
    ...
    setLoading(true);
    try {
      const response = await materielService.getSousCategoriesByCategorie(categorieId);
      if (response.success) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const nouveauData: Materiel = {
        ...
        entrepriseId: Number(selectedEntreprise),
          ...
          <form className="row g-3 mb-6" onSubmit={handleSubmit}>
            ...
            <div className="col-md-12">
              ...
              <select
                ...
                onChange={(e) => setSelectedEntreprise(e.target.value ? Number(e.target.value) : "")}
                required
              >
            ...
            <div className="col-md-6">
              ...
              <select
                ...
                onChange={(e) => setSelectedCategorie(e.target.value ? Number(e.target.value) : "")}
                required
              >
                <option value="">-- Sélectionnez --</option>
                {categories.map((c) => (
            ...
            <div className="col-md-6">
              ...
              <select
                ...
                onChange={(e) => setSelectedSousCategorie(e.target.value ? Number(e.target.value) : "")}
            ...
            <div className="col-md-6">
              ...
              <select
                ...
                onChange={(e) => setSelectedMarque(e.target.value ? Number(e.target.value) : "")}
                required
              >
                <option value="">-- Sélectionnez --</option>
                {marques.map((m) => (
            ...
            <div className="col-md-6">
              ...
              <select
                ...
                onChange={(e) => setSelectedModele(e.target.value ? Number(e.target.value) : "")}
