...
import { goToAjouterCategories, goToModifierCategories } from "../../../../shared/utils/navigation";
...
const ListeCategorie = () => {
  ...
  const getCategorieById = async (id: number) => {
    try {
      let response = await categorieService.getById(id);
      if (response.success) {
        goToModifierCategories(navigate, response.results)
      } else {
  ...
  const confirmAndDeleteCategorie = async (id: number) => {
  ...
  if (loading) {
    return (
      <div className="text-center py-5">
        ...
        <p className="mt-3">Chargement des types de materiels...</p>
      </div>
    );
  }
        ...
        <nav className="mb-3" aria-label="breadcrumb">
          <ol className="breadcrumb mb-0">
            <li className="breadcrumb-item">
              <Link to="/dashboard/liste-departements">Catégories</Link>
            </li>
            <li className="breadcrumb-item active">Catégories</li>
          </ol>
        </nav>
        <h2 className="text-bold text-body-emphasis mb-5">La liste des Catégories</h2>
        <div
          id="members"
          ...
          <div className="row align-items-center justify-content-between g-3 mb-4">
            ...
            <div className="col-auto">
              <div className="d-flex align-items-center">
                ...
                <button onClick={() => goToAjouterCategories(navigate)} className="btn btn-primary">
                        ...
                        <div className="btn-reveal-trigger position-static">
                          ...
                          <div className="dropdown-menu dropdown-menu-end py-2">
                            ...
                            <button
                              ...
                              onClick={() => getCategorieById(categorie.id)}
                            >
                              Modifier
                            </button>
                            <div className="dropdown-divider"></div>
                             <button
                              ...
                              onClick={() =>
                                confirmAndDeleteCategorie(categorie.id)
                              }
                            >
                              Supprimer
                            </button>
